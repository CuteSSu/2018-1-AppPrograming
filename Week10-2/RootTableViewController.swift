...
class RootTableViewController: UITableViewController {
    ...
    let fetchRequest = NSFetchRequest<NSManagedObject>(entityName: "ideaArray")
    do {
    ...
    */
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var display: String = ""
        if let phoneLabel = idea.value(forKey: "ideaDate") as? String {
            display = display + " " + phoneLabel
            
        }
        if let nameLabel = idea.value(forKey: "ideaTitle") as? String {
            display = nameLabel
            
        }
        cell.textLabel?.text = display
        cell.detailTextLabel?.text = idea.value(forKey: "ideaContent") as? String
