...
//  Login
//
//  Created by SWUCOMPUTER on 2018. 5. 15..
...
class FavoriteTableViewController: UITableViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        fetchedArray = [] // 배열을 초기화하고 서버에서 자료를 다시 가져옴 self.downloadDataFromServer()
    }
    
    func downloadDataFromServer() -> Void {
        let urlString: String = "http://10.0.1.3:8888/favorite/favoriteTable.php"
    ...
    @IBAction func buttonLogout(_ sender: UIBarButtonItem) {
        ...
        alert.addAction(UIAlertAction(title: "Yes", style: .default, handler: { action in
            let urlString: String = "http://10.0.1.3:8888/login/logout.php"
            guard let requestURL = URL(string: urlString) else { return }
